      ...
      $(function () {
        ...
        $(function () {
          ...
          $("#btnNoGenre").click(function () {
            for(var i=showNoGenre; i<showNoGenre+8; i++) $(noGenreCards[i]).fadeIn(300);
